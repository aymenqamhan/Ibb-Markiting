...
// التحقق من صلاحية المستخدم (مثلاً، دور 1 للمدير، دور 5 للموظف المسؤول عن الطلبات)
...
// جلب جميع الطلبات مع معلومات المستخدم الأساسية
$query = "
    SELECT
        o.id,
        o.order_date,
...
if ($stmt === false) {
    ...
    $message = "<div class='alert alert-danger'>حدث خطأ في قاعدة البيانات أثناء جلب الطلبات.</div>";
} else {
    $stmt->execute();
...
<head>
    ...
    <title>إدارة الطلبات - جميع الطلبات</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <link rel="stylesheet" href="/NEW_IBB/Style/admin_styles.css"> <style>
        .container-fluid {
            padding: 30px;
        }
        .table-responsive {
        ...
        .status-processing { background-color: #0dcaf0; color: #343a40; } /* Info Blue */
        .status-shipped { background-color: #6f42c1; color: white; } /* Purple */
        ...
        .payment-status-pending-payment { background-color: #ffc107; color: #343a40; } /* For payment pending status */
    </style>
</head>
<body>
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="mb-4 text-primary"><i class="bi bi-list-ol me-2"></i> جميع الطلبات</h2>
            <?php echo $message; ?>

            <?php if (empty($orders)): ?>
                <div class="alert alert-info text-center" role="alert">
                    <i class="bi bi-info-circle me-2"></i> لا توجد طلبات لعرضها حالياً.
                </div>
            <?php else: ?>
            ...
            <?php endif; ?>
                ...
                <div class="text-center mt-4">
                    <a href="../dashbord.php" class="btn btn-secondary"><i class="bi bi-arrow-right-circle-fill me-2"></i> العودة إلى  الادارة</a>
                </div>
    </div>
