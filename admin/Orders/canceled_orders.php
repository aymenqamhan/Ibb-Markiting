...
if ($stmt === false) {
    error_log("Failed to prepare cancelled orders query: " . $con->error);
    $message = "<div class='alert alert-danger'>حدث خطأ في قاعدة البيانات أثناء جلب الطلبات الملغاة.</div>";
} else {
    $stmt->execute();
...
<head>
    ...
    <title>إدارة الطلبات - الطلبات الملغاة</title>
...
<body>
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="mb-4 text-danger"><i class="bi bi-x-circle-fill me-2"></i> الطلبات الملغاة</h2>
            <?php echo $message; ?>

            <?php if (empty($orders)): ?>
                <div class="alert alert-info text-center" role="alert">
                    <i class="bi bi-info-circle me-2"></i> لا توجد طلبات ملغاة حالياً.
                </div>
            <?php else: ?>
